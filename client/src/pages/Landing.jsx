...
export default function Landing() {
  ...
  return (
    <div className="h-screen w-full relative overflow-hidden flex flex-col items-center justify-center p-6 text-center font-sans text-[#1d1d1f] bg-[#f8f9fb]">
      ...
      <div className="relative z-10">
        <motion.h1 initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="text-7xl font-bold tracking-tight mb-4 text-[#1d1d1f]">
          Content Buddy.
        </motion.h1>
        <motion.p initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.1 }} className="text-2xl text-gray-500 font-light mb-12">
